...
def home(request):
    ...
    fig_line.update_traces(mode='lines+markers+text', textposition='top center', marker=dict(size=5, line=dict(width=2, color='DarkSlateGrey')))
    ...
    return render(request, 'analytics.html', graphs)